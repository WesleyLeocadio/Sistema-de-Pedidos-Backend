...
public class DBService {
    ...
    public void instatiateTestDatabase() throws ParseException {
        ...
        Categoria cat3 = new Categoria(null, "Logística");
        Categoria cat4 = new Categoria(null, "Eletrônicos");
        Categoria cat5 = new Categoria(null, "Música");
        ...
        Cliente cli1 = new Cliente(null, "Wesley Leocadio", "silvawesley374@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
        Cliente cli2 = new Cliente(null, "Daniel Soares", "daniel@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli2.getTelefones().addAll(Arrays.asList("93883321", "34252625"));
        cli2.addPerfil(Perfil.ADMIN);

        Endereco e1 = new Endereco(null,"Ielmo ","05","Apto 303","Sao Raimundo","38220834",cli1,c1);
        Endereco e2 = new Endereco(null,"Natal","105","Sala 800","Centro","38777012",cli1,c2);
        cli1.getEnderecos().addAll(Arrays.asList(e1,e2));
        Endereco e3 = new Endereco(null, "Parnamirim", "216", null, "Centro", "281777012", cli2, c2);
